---
title: "Digital panacea or not: Platform Participation"
...
After a careful investigation of weibo posts, we can see that the context mainly represents individual real-time feelings, which implied a shot-term sentiment or comments for minutes even seconds. However, urban planning lasts for years and decades that affects people's life in long-term. It exists an inherent conflict between them that seems incompatible. The previous section of planning strategy trying to optimize public sentiment demonstrates it clearly that if we blindly design a city to improve short-term feeling, it will not improve long-term well-being (if we replace all the schools and hospitals with green spaces).  
  
It should be noted that this does not negate the importance of short-term feelings for urban planning; rather, it is critical for urban planners to understand how the built environment impacts individual short-term feelings and experiences. Individual short-term feeling can become an indicator for planner to balance short-term happiness and long-term welling when making urban decisions.

## A proposed social media platform 
Social media platform serves as a new form of infrastructure of urban life, which is embedded in daily experience.The strengths of social media platform can provide a massive bottom-up participation that traditional approaches can not provide. To address the shortcomings of existing social media data, the new social media platform should be capable of providing particular data on short-term happiness related with the built environment and long-term visions of urban planning from citizens living in that city.  
<br/>
