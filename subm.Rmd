...
author: "A critical approach to measure the quality of urban experience from a social media platform"
date: "Yuanzhao WANG"
Supervisor: 
output: pdf_document
---
...
* What data, methods, and frameworks could urban planners use to optimize residents' well-being and satisfaction with the built environment?    
* In what respects can social media data meet the data needs of planners seeking to apply such methods?  
* What sort of data gathering tool might produce data more appropriate to this purpose than social existing social media data?  
